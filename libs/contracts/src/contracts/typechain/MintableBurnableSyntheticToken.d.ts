...
export interface MintableBurnableSyntheticToken extends BaseContract {
  ...
  methods: {
    ...
    /**
     * Checks if a given account holds the Admin role.
    ...
    /**
     * Accessor method for the list of member with minter role
     */
    getMinterMembers(): NonPayableTransactionObject<string[]>;

    /**
     * Accessor method for the list of member with burner role
     */
