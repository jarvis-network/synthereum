  ...
  return (
    <>
      ...
      <p style={{ marginBottom: '2em' }}>
        ...
        sit amet, cursus ut augue. Posuere a magna enim. Nulla facilisi.
        Praesent sed nunc nec odio viverra sollicitudin non a mi.
      </p>
    </>
  );
};
  ...
  return (
    <>
      <p style={{ marginTop: '3em' }}>
        <small>
          Maecenas convallis est placerat sapien tincidunt sagittis. Ut
          hendrerit lacinia dolor ac vestibulum.
        </small>
      </p>
      <hr />
