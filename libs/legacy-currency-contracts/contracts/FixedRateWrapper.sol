...
contract FixedRateWrapper is ERC20 {
    ...
    constructor(IERC20 _token, uint256 _rate, string memory _name, string memory _symbol) ERC20(_name, _symbol){
        synth = _token;
        rate = _rate;
    }
    ...
    */
    ...
    function unwrap(uint256 _amount) public {
        ...
        userFunds[msg.sender] = userFunds[msg.sender].sub(_amount);
