...
import {
  calculateWithdrawLiquidationPrice,
  calculateWithdrawNewCollateralizationRatio,
} from '../helpers/MinMax';
...
export const useCalculateUserCollateralizationRatioLiquiationpriceFee = (
  ...
  return useMemo(() => {
    ...
    return {
      newRatio: calculateWithdrawNewCollateralizationRatio(
      ...
      liquidationPrice: calculateWithdrawLiquidationPrice(
