    ...
    return (
      <Html lang={"en"}>
        <Head>
          ...
          <link rel="apple-touch-icon" sizes="192x192" href="/icons/maskable_192.png" />
          <link rel="apple-touch-icon" sizes="512x512" href="/icons/maskable_512.png" />
          <link rel="shortcut icon" sizes="192x192" href="/icons/icon_192.ico" />
